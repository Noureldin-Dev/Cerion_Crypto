    ...
    <Container maxW="container.xl" bg={lightBg} _dark={{bg: darkBg}} minH="100vh">
      <VStack spacing={8} align="stretch">
        <Box textAlign="center">
          <Heading as="h1" size="2xl" mb={2} color={lightColor} _dark={{color: darkColor}}>Top Gainers 📈</Heading>
          <Text fontSize="xl" color={lightSubtextColor} _dark={{color: darkSubtextColor}}>Discover the best performing cryptocurrencies in the last 24 hours</Text>
        </Box>
        ...
        {isLoading ? (
          ...
          <Box textAlign="center" p={8} bg={lightCardBg} _dark={{bg: darkCardBg}} borderRadius="lg" boxShadow="xl">
            <Text fontSize="xl" color={lightColor} _dark={{color: darkColor}}>No top gainers to display at the moment. Check back later!</Text>
          </Box>
        )}
      </VStack>
    </Container>
