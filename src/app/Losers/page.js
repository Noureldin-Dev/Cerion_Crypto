    ...
    <Container maxW="container.xl" py={10} bg={bg} minH="100vh">
      <VStack spacing={8} align="stretch">
        <Box textAlign="center">
          <Heading as="h1" size="2xl" mb={2} color={color}>Top Losers 📉</Heading>
          <Text fontSize="xl" color={useColorModeValue('gray.600', 'gray.400')}>Discover the worst performing cryptocurrencies in the last 24 hours</Text>
        </Box>
        ...
        {isLoading ? (
          ...
          <Box textAlign="center" p={8} bg={cardBg} borderRadius="lg" boxShadow="xl">
            <Text fontSize="xl" color={color}>No top losers to display at the moment. Check back later!</Text>
          </Box>
        )}
      </VStack>
    </Container>
